...
def saveEntry(taskInfo):
    os.remove('Stuff/loggingInfo.csv')

    with open('Stuff/loggingInfo.csv', 'w') as w:
...
if not os.path.exists('Stuff/loggingInfo.csv'):
    with open('Stuff/loggingInfo.csv', 'w') as w:
        pass
